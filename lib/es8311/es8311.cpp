 ...
 *
 * Vendored from github.com/waveshareteam/ESP32-S3-ePaper-13.3E6
 * (example/Arduino-3.2.0/examples/02_Audio_out/es8311.cpp) — see /NOTICE.md.
 * Unmodified from upstream; already uses Arduino Wire for I2C internally.
 */
